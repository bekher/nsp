...
var onCommand = function (args) {
  ...
  var repo = !!args.github ? 'https://raw.githubusercontent.com/'+args.github+'/master/package.json' : '';

  Check({ package: pkgPath, packageUrl: repo, shrinkwrap: shrinkwrapPath, offline: args.offline, advisoriesPath: args.advisoriesPath }, function (err, result) {
